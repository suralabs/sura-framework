...
final class ObjectHelpers
{
	...
	public static function strictGet(string $class, string $name): void
	{
		...
		throw new Sura\Exception\MemberAccessException("Cannot read an undeclared property $class::\$$name" . ($hint ? ", did you mean \$$hint?" : '.'));
	}
	...
	public static function strictSet(string $class, string $name): void
	{
		...
		throw new Sura\Exception\MemberAccessException("Cannot write to an undeclared property $class::\$$name" . ($hint ? ", did you mean \$$hint?" : '.'));
	}
	...
	public static function strictCall(string $class, string $method, array $additionalMethods = []): mixed
	{
		...
		throw new Sura\Exception\MemberAccessException("Call to undefined method $class::$method()" . ($hint ? ", did you mean $hint()?" : '.'));
	}
	...
	public static function strictStaticCall(string $class, string $method): void
	{
		...
		throw new Sura\Exception\MemberAccessException("Call to undefined static method $class::$method()" . ($hint ? ", did you mean $hint()?" : '.'));
	}
