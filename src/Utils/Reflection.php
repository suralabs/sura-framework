...
final class Reflection
{
	...
	private static function getType($reflection, ?\ReflectionType $type, bool $asArray = false): array|string|null
    {
		if ($type === null) {
			...
			throw new Sura\Exception\InvalidStateException('The ' . self::toString($reflection) . ' is not expected to have a union type.');

		} else {
			throw new Sura\Exception\InvalidStateException('Unexpected type of ' . self::toString($reflection));
		}
	}
	...
	public static function toString(\Reflector $ref): string
	{
		if ($ref instanceof \ReflectionClass) {
			...
			throw new Sura\Exception\InvalidArgumentException;
		}
	}
	...
	public static function expandClassName(string $name, \ReflectionClass $context): string
	{
		...
		if (empty($name)) {
			throw new Sura\Exception\InvalidArgumentException('Class name must not be empty.');
	...
	public static function getUseStatements(\ReflectionClass $class): array
	{
		if ($class->isAnonymous()) {
			throw new Sura\Exception\NotImplementedException('Anonymous classes are not supported.');
		}
		static $cache = [];
