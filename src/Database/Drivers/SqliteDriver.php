 ...
 */
class SqliteDriver implements Sura\Database\Driver
{
	...
	public function convertException(\PDOException $e): Sura\Database\DriverException
	{
		...
		if ($code !== 19) {
			...
			return Sura\Database\ConstraintViolationException::from($e);
		}
	}
		...
		for ($col = 0; $col < $count; $col++) {
			...
			if (isset($meta['sqlite:decl_type'])) {
				$types[$meta['name']] = in_array($meta['sqlite:decl_type'], ['DATE', 'DATETIME'], true)
					? Sura\Database\IStructure::FIELD_UNIX_TIMESTAMP
