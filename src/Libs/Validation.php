...
class Validation
{
     ...
     * @return bool|string
     */
    #[Pure] public static function checkIp(string $ip): bool|string
    {
     ...
     * @return bool
     */
    public static function checkName(string $user_name): bool
    {
        if (empty($user_name)) {
            return false;
        }
     ...
     * @return bool
     */
    #[Pure] public static function checkPassword(string $password_first, string $password_second): bool
    {
     ...
     * @return bool
     */
    #[Pure] public static function checkEmail(string $email): bool
    {
        if (empty($email)) {
            return false;
        }
     ...
     * @return string
     */
    public static function stripData(string $text): string
    {
     ...
     * @return string
     */
    public static function replaceRn(string $source): string
    {
...
//		$replace[] = "\n";
     ...
     * @return string
     */
    public static function rnReplace(string $source): string
    {
...
//        $source = str_ireplace(array("{", "`", "{theme}"), array("&#123;", "&#96;", "&#123;theme}"), $source);
     ...
     * @return string
     */
    public static function wordFilter($source, $encode = true): string
    {
        $safe_mode = false;
     ...
     * @return false|int
     */
    public static function strlen8Bit($binary_string): false|int
    {
        if (function_exists('mb_strlen')) {
     ...
     * @return false|string
     */
    public static function substr8Bit($binary_string, $start, $length): false|string
    {
