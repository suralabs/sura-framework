...
class MysqliDb
{
     ...
     */
    protected function _bindParam($value) : string
    {
     ...
     * @throws Exception
     */
    private function _buildInsert($tableName, $insertData, $operation) : bool
    {
        if ($this->isSubQuery) {
            return;
        }
     ...
     * @return string
     */
    protected function replacePlaceHolders($str, $vals) : string
    {
        $i = 1;
        $newStr = "";
     ...
     * @throws Exception
     */
    public function interval($diff, $func = "NOW()") : string
    {
     ...
     * @throws Exception
     */
    public function now($diff = null, $func = "NOW()") : array
    {
     ...
     * @throws Exception
     */
    public function paginate ($table, $page, $fields = null) : array
    {
