...
final class Db implements DbInterface
{
	 ...
	 */
	public function __construct(public bool|object $db_id = false, public int $query_num = 0, public string $mysql_error = '', public string $mysql_version = '', public int $mysql_error_num = 0, public float $MySQL_time_taken = 0, public bool|string|object $query_id = false, public $db_config = array(),)
	{
...
//        return $this->close();
	 ...
	 * @return bool|\mysqli_result|object|string
	 */
